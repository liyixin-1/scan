...
def register_blueprints(app):
    ...
    app.register_blueprint(portscan_bp, url_prefix='/api/portscan')

    from app.ipscan import ipscan_bp
    app.register_blueprint(ipscan_bp, url_prefix='/api/ipscan')

    from app.blowup import blowup_bp
    app.register_blueprint(blowup_bp, url_prefix='/api/blowup')
